<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RandomFile.aspx.cs" Inherits="Demo_UpWebShell.RandomFile" %>
        ...
        <form id="form1" runat="server">
            <div id="CPopupImageUpload">
                ...
                <div id="RightBar">
                    <div id="FileBox">
                        <div id="ListFile">
                            <asp:Repeater ID="rptrList" runat="server" OnItemDataBound="rptrList_ItemDataBound_1">
                                <HeaderTemplate>
                                    <ul>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <li>
                                        <asp:LinkButton ID="lbtnDelete" runat="server" CssClass="btn-delete" CommandArgument='<%# Eval("PATH") %>' OnClick="lbtnDelete_Click_1">Xóa</asp:LinkButton>
                    ...
                    <div id="UploadBar">
                        Tệp tin: <asp:FileUpload ID="FileUpload1" Width="120px" runat="server" CssClass="aspNet-FileUpload" />
                        <span style="color:#888; font-size:13px;">(*.gif; *.jpg; *.png; )</span>
                        <asp:Button ID="btnUpload" runat="server" Text="Tải lên" OnClick="btnUpload_Click_1" CssClass="aspNet-Button" />
