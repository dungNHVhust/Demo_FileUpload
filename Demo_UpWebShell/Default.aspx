<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Demo_UpWebShell.Default" %>
            ...
            <div id="CPopupImageUpload">
                ...
                <div id="RightBar">
                    <div id="FileBox">
                        <div id="ListFile">
                            <asp:Repeater ID="rptrList" runat="server" OnItemDataBound="rptrList_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <li>
                                        <asp:LinkButton ID="lbtnDelete" runat="server" CssClass="btn-delete" CommandArgument='<%# Eval("PATH") %>' OnClick="lbtnDelete_Click">Xóa</asp:LinkButton>
                    ...
                    <div id="UploadBar">
                        ...
                        <asp:Button ID="btnUpload" runat="server" Text="Tải lên" OnClick="btnUpload_Click" CssClass="aspNet-Button" />
